...
%%%
Over the past centuries, humans have used and learned musical instruments such as the piano. When learning these instruments, there are several problems that are encountered by the learner. These problems can be either \textit{physical} (posture, height, length of fingers, flexibility), \textit{psycho-cognitive} (visual, auditory, tactile perception, hand-eye-foot coordination) \cite{simpson1966classification}, \textit{cognitive} (acquiring, understanding, retaining and applying music knowledge) \cite{hanna2007new} and/or \textit{affective} (willingness to learn, motivation to practice) in nature) \cite{mccarthy2002music, burns2020using}. These problems have introduced technology interventions in the form of augmentation \cite{howard1996kodaly, burns2020using, blackshaw2020wearing, anggoro2020study, comeau2012playing} to make piano learning easier. As such 

With these problems in mind, musical instruments such as the piano and their design, have improved over the past decades. As the design of these instruments play a crucial role on how a user attempts to learn the piano, the curve associated with learning it has increased as well. The piano, as a musical instrument have been augmented through digital technologies (in the form of modules, synthesizers, and other auxiliary peripherals) to help address some of the problems in learning it.  
