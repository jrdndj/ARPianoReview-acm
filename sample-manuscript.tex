...
\todok{Please give feedback. Thank you!}
\section{Background}
\subsection{On learning and music education}
...
\begin{figure*}[t]
    ...
    \todos{Please check if these graphs make sense or is there a better way to present them.}
\todok{Please check if these graphs make sense or is there a better way to present them.}
\end{figure*}  
...
Apart from these trends augmentations, we were able to draw different themes that we believe have inspired these contributions. These themes were patterned from the how the piano learning process takes place inspired by the different methodologies on teaching them and on Social Learning Theory (SLT) \cite{rogers2014piano, bandura1977social}. We analyzed the different contributions mentioned in the previous section and how they are matched with these learning frameworks and techniques. 

\subsection{Ensuring correct finger positioning for novice learners}

\todoj{see discussion below on agents and tutors. synthesize this to fit the new subsection title. }
...
\todoj{see discussion below on piano roll visualizations. synthesize this to fit the new subsection title. }

Piano roll visualizations as substitute for complex notation
...
\todoj{see discussion below on learning modes. synthesize this to fit the new subsection title. }
...
\todoj{this is something that i have not written but there are a lot of papers especially from NIME that have mentioned this. do more reading and synthesize. sketch when necessary. also include the latest paper by Karolus. }
