...
\begin{table*}[h]
\caption{Table of augmented piano prototype studies and a checklist of their features based on contribution categories as described in section \ref{sec: trends}.}
\label{tab:augmentedonly}
\resizebox{!}{.3\paperheight}{%
\begin{tabular}{ll|l|r|c|c|c|c|c|c|c|c|c|c|c|c|l} \hline \hline
\textbf{Paper} & \textbf{Author}                                        & Year & \# & \textbf{GR} & \textbf{MG} & \textbf{AX} & \textbf{SN} & \textbf{PR} & \textbf{OS} & \textbf{KB} & \textbf{AT} & \textbf{PR} & \textbf{US} & \textbf{HT} & \textbf{LM} &  \textbf{Others} \\ \hline
P1             & \citet{ogata2017keyboard}             & 2017                     &    &                     &         &            &             &            &                 &       &&&&&& \textit{this is the longest text that i can think of } \\ \hline
...
P5             & \citet{hadjakos2012pianist}           & 2012                     &    &                     &         &            &             &   \ding{51}         &                 &     &&&&&&   \\ \hline
...
% \usepackage{graphicx}
\begin{table*}[t]
\caption{List of studies with user evaluation (labelled as \textbf{US} as seen from Table \ref{tab:augmentedonly}). This table provides an overview of their treatments, metrics, constructs and tools used.}
\label{tab: us-all}
\resizebox{\textwidth}{!}{%
