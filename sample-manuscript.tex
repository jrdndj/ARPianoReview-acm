...
\begin{enumerate}
    ...
    \item The prototype is an augmented piano%as seen in Section \ref{sec: bg}.
\end{enumerate}
...
\begin{figure}[t]
    ...
    \caption{The distribution of the \red{61} augmented piano papers over the last two decades included in our literature review. %N.B. The the figure here describes the number of papers filtered from the inclusion criteria in subsection \ref{subsec: criteria}.
    }
